...
public final class ClimateServiceGrpc {
	...
	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
			+ "HvacOnOff", requestType = grpc.services.climate.SwitchRequest.class, responseType = grpc.services.climate.SwitchResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
	public static io.grpc.MethodDescriptor<grpc.services.climate.SwitchRequest, grpc.services.climate.SwitchResponse> getHvacOnOffMethod() {
		...
		if ((getHvacOnOffMethod = ClimateServiceGrpc.getHvacOnOffMethod) == null) {
			synchronized (ClimateServiceGrpc.class) {
				if ((getHvacOnOffMethod = ClimateServiceGrpc.getHvacOnOffMethod) == null) {
					ClimateServiceGrpc.getHvacOnOffMethod = getHvacOnOffMethod = io.grpc.MethodDescriptor.<grpc.services.climate.SwitchRequest, grpc.services.climate.SwitchResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(generateFullMethodName("Climate.ClimateService", "HvacOnOff"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(grpc.services.climate.SwitchRequest.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(grpc.services.climate.SwitchResponse.getDefaultInstance()))
							.setSchemaDescriptor(new ClimateServiceMethodDescriptorSupplier("HvacOnOff")).build();
				}
			}
		}
	...
	private static volatile io.grpc.MethodDescriptor<grpc.services.climate.HvacRequest, grpc.services.climate.HvacResponse> getHvacTemperatureMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
			+ "HvacTemperature", requestType = grpc.services.climate.HvacRequest.class, responseType = grpc.services.climate.HvacResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
	public static io.grpc.MethodDescriptor<grpc.services.climate.HvacRequest, grpc.services.climate.HvacResponse> getHvacTemperatureMethod() {
		...
		if ((getHvacTemperatureMethod = ClimateServiceGrpc.getHvacTemperatureMethod) == null) {
			synchronized (ClimateServiceGrpc.class) {
				if ((getHvacTemperatureMethod = ClimateServiceGrpc.getHvacTemperatureMethod) == null) {
					ClimateServiceGrpc.getHvacTemperatureMethod = getHvacTemperatureMethod = io.grpc.MethodDescriptor.<grpc.services.climate.HvacRequest, grpc.services.climate.HvacResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
							.setFullMethodName(generateFullMethodName("Climate.ClimateService", "HvacTemperature"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(grpc.services.climate.HvacRequest.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(grpc.services.climate.HvacResponse.getDefaultInstance()))
							.setSchemaDescriptor(new ClimateServiceMethodDescriptorSupplier("HvacTemperature")).build();
				}
			}
		}
	...
	private static volatile io.grpc.MethodDescriptor<grpc.services.climate.CoLevelRequest, grpc.services.climate.ExtractionResponse> getCheckCOMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
			+ "checkCO", requestType = grpc.services.climate.CoLevelRequest.class, responseType = grpc.services.climate.ExtractionResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
	public static io.grpc.MethodDescriptor<grpc.services.climate.CoLevelRequest, grpc.services.climate.ExtractionResponse> getCheckCOMethod() {
		...
		if ((getCheckCOMethod = ClimateServiceGrpc.getCheckCOMethod) == null) {
			synchronized (ClimateServiceGrpc.class) {
				if ((getCheckCOMethod = ClimateServiceGrpc.getCheckCOMethod) == null) {
					ClimateServiceGrpc.getCheckCOMethod = getCheckCOMethod = io.grpc.MethodDescriptor.<grpc.services.climate.CoLevelRequest, grpc.services.climate.ExtractionResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(generateFullMethodName("Climate.ClimateService", "checkCO"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(grpc.services.climate.CoLevelRequest.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(grpc.services.climate.ExtractionResponse.getDefaultInstance()))
							.setSchemaDescriptor(new ClimateServiceMethodDescriptorSupplier("checkCO")).build();
				}
			}
		}
	...
	public static abstract class ClimateServiceImplBase implements io.grpc.BindableService {
		...
		public final io.grpc.ServerServiceDefinition bindService() {
			return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
					.addMethod(getHvacOnOffMethod(), asyncUnaryCall(
							new MethodHandlers<grpc.services.climate.SwitchRequest, grpc.services.climate.SwitchResponse>(
									this, METHODID_HVAC_ON_OFF)))
					.addMethod(getHvacTemperatureMethod(), asyncServerStreamingCall(
							new MethodHandlers<grpc.services.climate.HvacRequest, grpc.services.climate.HvacResponse>(
									this, METHODID_HVAC_TEMPERATURE)))
					.addMethod(getCheckCOMethod(), asyncUnaryCall(
							new MethodHandlers<grpc.services.climate.CoLevelRequest, grpc.services.climate.ExtractionResponse>(
	...
	public static final class ClimateServiceStub extends io.grpc.stub.AbstractStub<ClimateServiceStub> {
		...
		private ClimateServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected ClimateServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
	...
	public static final class ClimateServiceBlockingStub extends io.grpc.stub.AbstractStub<ClimateServiceBlockingStub> {
		...
		private ClimateServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected ClimateServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
	...
	public static final class ClimateServiceFutureStub extends io.grpc.stub.AbstractStub<ClimateServiceFutureStub> {
		...
		private ClimateServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
			super(channel, callOptions);
		}

		@java.lang.Override
		protected ClimateServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
	...
	private static final class ClimateServiceFileDescriptorSupplier extends ClimateServiceBaseDescriptorSupplier {
		ClimateServiceFileDescriptorSupplier() {
		}
	}

	private static final class ClimateServiceMethodDescriptorSupplier extends ClimateServiceBaseDescriptorSupplier
			...
			synchronized (ClimateServiceGrpc.class) {
				...
				if (result == null) {
					serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
							...
							.addMethod(getHvacOnOffMethod()).addMethod(getHvacTemperatureMethod())
							.addMethod(getCheckCOMethod()).build();
				}
			}
		}
		return result;
